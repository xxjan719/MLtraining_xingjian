## Decision Tree
We will first implement the decision tree for classification problems.
Then we will do modify it for regression problems.
Your task: understand the decision tree and change it to a regression method.
